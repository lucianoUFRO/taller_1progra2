...
// metodo para el boton de agregar
public void llenarTabla(Estudiante p) {
        this.estudiante.add(p);
        o[0] = p.getNombre();
        o[1] = p.getMatricula();
        o[2] = p.getCarrera();
        o[3] = p.getCorreo();
...
public Estudiantes cargarEstudiantes() {

        Estudiante p = new Estudiante(this.nombre.getText(),this.Matricula.getText(), this.Carrera.getText(), this.correo.getText();
        this.Nombre.setText("");
